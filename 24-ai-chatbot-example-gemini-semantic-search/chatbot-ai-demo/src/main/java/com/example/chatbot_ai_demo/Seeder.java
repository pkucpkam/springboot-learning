            ...
            if (productRepository.count() == 0) {
                ...
                List<Product> products = List.of(
                        Product.builder()
                                ...
                                .embedding(generateEmbedding("Laptop ASUS ROG Strix Laptop gaming RTX 4060, RAM 16GB, SSD 1TB"))
                                .build(),
                        Product.builder()
                                ...
                                .embedding(generateEmbedding("Laptop MSI GF63 Thin Laptop gaming RTX 4050, RAM 16GB, SSD 512GB"))
                                .build(),
                        Product.builder()
                                .name("iPhone 13")
                                .category("Điện thoại")
                                ...
                                .embedding(generateEmbedding("iPhone 13, chip A15 Bionic, camera kép 12MP"))
                                .build(),
                        Product.builder()
                                ...
                                .embedding(generateEmbedding("Samsung Galaxy S23 FE, màn 6.4 inch, Snapdragon 8 Gen 1"))
                                .build(),
                        Product.builder()
                                ...
                                .embedding(generateEmbedding("Tai nghe Sony WH-1000XM5, chống ồn chủ động, pin 30h, Bluetooth 5.2"))
                                .build()
                );

                productRepository.saveAll(products);
                System.out.println("✅ Seeded sample products with embeddings into database!");
            }
        };
    }

    // Demo tạo embedding vector 128D (thay bằng Gemini / Hugging Face embedding thật khi triển khai)
